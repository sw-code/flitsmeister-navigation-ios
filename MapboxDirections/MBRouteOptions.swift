...
public struct MBDirectionsProfileIdentifier: RawRepresentable, Equatable {
    ...
    public static let automobile = Self(rawValue: "gh/driving")
    public static let automobileAvoidingTraffic = Self(rawValue: "gh/driving-traffic")
    public static let cycling = Self(rawValue: "gh/cycling")
    public static let walking = Self(rawValue: "gh/walking")
}
